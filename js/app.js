...
//    controlLeft = new THREE.OrbitControls( cameraLeft );
  ...
  //  controlLeft.addEventListener( 'change', render );
...
function render() {
    ...
    //cameraLeft.position.x += ( mouseX - cameraLeft.position.x ) * .05;
    //cameraLeft.position.y += ( - mouseY - cameraLeft.position.y ) * .05;
    ...
    //cameraRight.position.x += ( mouseX - cameraRight.position.x ) * .05;
    //cameraRight.position.y += ( - mouseY - cameraRight.position.y ) * .05;
...
function createShaderMaterial(id, light) {
    ...
    //                value: 0.4
    //            },
    //            "uTex": { type: "t", value: loadTexture('img/bear.gif') }
    //        }
    //    }
    //};
    //
